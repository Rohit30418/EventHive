...
import useMicrositePresentation from "./hooks/useMicrositePresentation";
...
const MicrositeHome = () => {
  ...
  const event = data ?? { EventName: "", eventDate: "" };
  ...
  const {
    ...
    fallbackPortraits,
    speakers,
  } = useMicrositePresentation(event);
  ...
  return (
    ...
    >
      ...
      <SpeakersSection
        speakers={speakers}
        fallbackPortraits={fallbackPortraits}
